...
# wget -O - http://192.168.0.231/acs/a/s/ipssh/ipsshxsa/sh1.192.168.0.201.sh | sh
...
# wget -O - --ftp-user=admin --ftp-password=1 ftp://192.168.0.231/a/mnt/s/a/ai/ais/i/home/going/workspace/am/website/aw/iisxa/acs/a/s/ipssh/ipsshxsa/sh1.192.168.0.201.sh | sh
...
echo "IPADDR=192.168.0.201" >> /home/going/workspace/acs/a/c/zbak/ifcfg-eth0.new
...
# wget -O - http://192.168.0.231/file/ipssh/home/going/workspace/acs/a/s/etc/ipsshxsc/sh1.192.168.0.201.sh | sh
# systemctl restart network
